    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorizeHttpRequests ->
            authorizeHttpRequests
                ...
                .requestMatchers("/api/users/signup", "/api/users/login", "/api/users/kakao/callback", "/api/users/google/callback", "/api/waste/records",  "/api/waste/records/{recordId}").permitAll()
